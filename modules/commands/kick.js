...
module.exports.languages = {
    "vi": {
        "error": "Có lỗi rồi, fix lại đi rồi tao đá nó ra!",
        "needPermssion": "Đưa bố quản trị viên rồi làm gì thì làm!",
...
module.exports.run = async function ({ api, event, getText, Threads }) {
    ...
    try {
        ...
        if (!mention[0]) return api.sendMessage("Mày phải tag thằng cần kick!", event.threadID);
